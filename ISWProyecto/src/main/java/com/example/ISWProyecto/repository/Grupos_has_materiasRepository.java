...
public interface Grupos_has_materiasRepository extends JpaRepository<Grupos_has_materias, String>{
	...
	@Query("SELECT a FROM Grupos_has_materias a where a.grupos_grupo = :grupos_grupo and a.materias_idmateria = :materias_idmateria")
	Grupos_has_materias findGrupos_has_materias(@Param("grupos_grupo") String grupos_grupo, @Param("materias_idmateria") String materias_idmateria);
