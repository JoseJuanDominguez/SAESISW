...
public class Grupos_has_materiasServiceImpl implements IGrupos_has_materiasService{
	...
	@Override
	public Grupos_has_materias findGrupos_has_materias(String boleta, String password) {
		return grupos_has_materiasRepository.findGrupos_has_materias(boleta, password);
	}
